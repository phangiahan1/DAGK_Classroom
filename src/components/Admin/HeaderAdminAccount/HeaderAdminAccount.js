...
const HeaderAdminAccount = ({ classData }) => {
                ...
                <Toolbar className={classes.toolbar}>
                    ...
                    <div>
                        <Tabs value={tabValue} centered>
                            <Link to={`/admin/admin`} style={{ textDecoration: 'none', color: 'white' }} onClick={() => { setTabValue(0) }}><Tab label="LIST ADMIN ACCOUNT" style={{ textTransform: 'none' }} value="0" /></Link>
                            <Link to={`/admin/adminCreate`} style={{ textDecoration: 'none', color: 'white' }} onClick={() => { setTabValue(1) }}><Tab label="CREATE ADMIN ACCOUNT" style={{ textTransform: 'none' }} value="1" /></Link>
...
export default HeaderAdminAccount